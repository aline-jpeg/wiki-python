...
print('------ LOJA DE TINTAS 02 ------')
print('')
print('Quantos mt² deseja pintar?')
area = int(input(''))
print('')
...
print('Para pintar essa metragem, você vai precisar de:')
print('')
print(f'{latas} lata(s) || VALOR TOTAL: R$ {precoLata :.2f}')
print(f'{galao} galão(ões) || VALOR: R$ {precoGalao:.2f}')
print(f'Economize com : {mixLatas} lata(s) & {mixGaloes :.0f} galão(ões) por apenas: R$ {totalMix :.2f}')